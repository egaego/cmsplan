...
<div aria-required="true" class="form-group required form-group-default form-group-default-select2 {{ $errors->has('vendor_id') ? 'has-error' : ''}}">
    {!! Form::label('vendor_id', 'Vendor') !!}
    {!! Form::select('vendor_id', \App\Vendor::pluck('name', 'id'), null, ['class' => 'select2 full-width', 'data-init-plugin' => 'select2']) !!}
